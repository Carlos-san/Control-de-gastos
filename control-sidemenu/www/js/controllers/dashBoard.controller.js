...
function dashController($scope, $cordovaSQLite, $ionicModal, movimientosService, generalesService) {
  ...
  $scope.bntAgregarSalida = function () {
    inicializaSalida();
    $ionicModal.fromTemplateUrl('templates/modals/agregar-salida.html', {
      scope: $scope,
      animation: 'fade-in-scale'
    }).then(function(modal) {
  ...
  $scope.bntAgregarEntrada = function () {
    inicializaEntrada();
    $ionicModal.fromTemplateUrl('templates/modals/agregar-entrada.html', {
      scope: $scope,
      animation: 'fade-in-scale'
    }).then(function(modal) {
  ...
  $scope.bntAgregarActividad = function () {
    inicializaSalida();
    $ionicModal.fromTemplateUrl('templates/modals/agregar-actividad.html', {
      scope: $scope,
      animation: 'fade-in-scale'
    }).then(function(modal) {
