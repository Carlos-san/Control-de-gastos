var semillaBd = {
  ...
  creacionTablas: {
    '1.0': [
      ...
      "CREATE TABLE IF NOT EXISTS actividad (id INTEGER PRIMARY KEY, id_base INTEGER, nombre TEXT, id_tactividad INTEGER, fecha TEXT, descripcion TEXT, FOREIGN KEY(id_base) REFERENCES base(id), FOREIGN KEY(id_tactividad) REFERENCES tactividad(id))",
